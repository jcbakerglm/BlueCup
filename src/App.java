 ...
 * Things to do:
 * 
 * 1. Parameterize initGUI so that it can be used for both windows. - done
 * 2. TODO: Look for other ways to streamline and improve code.
 *
 ********************************************************************/
public class App {
	static {
    ...
    public static void main(String[] args) { //TODO: Add command-line arg to support changing the video capture device.
		a.runMainLoop();
	}
